const weekly_spaces =
    `
   <section class="weekly-spaces text-center py-5">
        <div class="container">
            <!-- Header Section -->
            <h2 class="section-title">WEEKLY SPACES</h2>
            <p class="section-subtitle">Every Tuesday at 8PM EST.</p>
